 ...
 * 红,绿,蓝,透明度 (默认-90,-90,-90,0)
 * @default -90,-90,-90,0
 *
 * @param 日出色调
 * @parent ---画面色调---
 * @desc 时间为 6:00-8:00 时的画面色调。
 * 红,绿,蓝,透明度 (默认60,60,60,0)
 * @default 60,60,60,0
 *
 * @param 日落色调
 * @parent ---画面色调---
 * @desc 时间为 15:00-17:00 时的画面色调。
 * 红,绿,蓝,透明度 (默认48,-14,-14,0)
 * @default 48,-14,-14,0
 *
 * @param 黄昏色调
 * @parent ---画面色调---
 ...
 * 时间系统使得游戏能够表现出白天黑夜、日出日落效果。
 * 时间系统关联了变量和开关，你可以设置一个只在周一开放的商店，周末才出现的
